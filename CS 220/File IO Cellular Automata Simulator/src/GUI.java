...
public class GUI extends JFrame implements ActionListener, ChangeListener {
    ...
    private JButton clear, random, step, run, load, save;
    ...
    private void updateSizeSliders() {
        this.gridHeightSlider.setValue(this.caPanel.getGridHeight());
        this.gridWidthSlider.setValue(this.caPanel.getGridWidth());
        this.gridHeightSlider.invalidate();
        this.gridWidthSlider.invalidate();
        this.gridHeightSlider.repaint();
        this.gridWidthSlider.repaint();
    }
    ...
    class CAPanel extends JPanel implements MouseListener {
        ...
        public CAPanel(int gridHeight, int gridWidth){
            model = new CAModelIO(gridHeight, gridWidth);
            setInteractive(true);
        }
